...
and here's what the filter looks like as a function of symbol period.  This is also called the filter's **impulse response**.  There are 10 symbol periods because `delay` is set to 5.  If `delay` was set to 23, we'd cover 46 symbol periods.  If you like formulas, here's the rule   
