...
Now it's time to start implementing a basic modulator in Python.   
...
The next step is to convert the bits to complex QPSK symbols.  We start by splitting up the bits into inphase and quadrature components.  As long as you keep the same convention in the receiver code, you can do this however you want. I like to make the even bits the in-phase part and the odd-bits the quadrature part.  After this we convert the 
